// METAMASK CONNECTION
const TIMEOUT = 1000;
const COLLECTION_NAME = 'Lucky Leprechauns Club';
let editions = [];
let dots = 1;
...
function updateStatusText(isOwner, checking) {
  ...
  if(checking) {
    ...
    if(isOwner) {
      statusText.innerText = `You own ${editions.length} of ${COLLECTION_NAME}`;
    } else {
      statusText.innerText = `No ${COLLECTION_NAME} in your wallet`;
    }
  }
